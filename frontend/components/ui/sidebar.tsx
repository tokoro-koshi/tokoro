    ...
    return (
      <div
        ...
        className={cn(
          ...
          state === 'collapsed' && 'max-md:invisible'
        )}
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            'relative duration-200 ' +
              // "h-svh " +
              'w-[--sidebar-width] bg-transparent transition-[width] ease-linear',
        ...
        <div
          className={cn(
            'sticky bottom-0 z-10 duration-200 ' +
            ...
            state === 'collapsed' && 'max-md:invisible max-md:!w-0',
            className
          )}
          {...props}
        >
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant='ghost'
      size='icon'
      className={cn('h-7 w-7 stroke-2', className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
    ...
    >
      ...
      <span className='sr-only h-6 w-6'>Toggle Sidebar</span>
    </Button>
  );
});
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left truncate text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
