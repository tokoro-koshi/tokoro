...
/**
 * A DTO for creating or updating the Privacy information
 */
@Schema(
        name = "CreateUpdatePrivacyDto",
        description = "A DTO for creating or updating the Privacy information"
)
public record CreateUpdatePrivacyDto(
        @Schema(
                name = "title",
